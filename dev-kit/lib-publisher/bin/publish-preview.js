...
const npmToken = `af7d33f0-cdc3-4764-b663-74eb87d1e63b`
...
`
  ...
  以下是预览链接，可以将它分享给评阅人： 
    https://aliyun.github.io/alibabacloud-console-components/doc-preview?pkg=${encodeURIComponent(
      previewPkgName
    )}&ver=${encodeURIComponent(previewPkgVersion)}
  如果github page访问较慢，可以访问国内镜像站点：
    https://gitee.com/csr632/alibabacloud-console-components/doc-preview?pkg=${encodeURIComponent(
      previewPkgName
    )}&ver=${encodeURIComponent(previewPkgVersion)}`)
})()
